...
@section('content')
<form action="/admin/updateplayer/{{$data -> id}}" method="POST" enctype="multipart/form-data" class="overflow-y-auto h-32">
    ...
    <div class="border-b border-gray-900/10 pb-12">
      ...
      <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        <div class="sm:col-span-3">
          ...
          <div class="mt-2">
            <input type="text" name="nama_depan" value="{{$data ->nama_depan}}"   class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          </div>
        </div>
        ...
        <div class="sm:col-span-3">
          ...
          <div class="mt-2">
            <input type="text" name="nama_belakang"  value="{{$data ->nama_belakang}}"   class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          </div>
        </div>
        ...
        <div class="sm:col-span-4">
          ...
          <div class="mt-2">
            <input  type="text" name="tanggal_lahir" value="{{$data ->tanggal_lahir}}"  class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          </div>
        </div>

        <div class="sm:col-span-4">
          <label for="email" class="block text-sm font-medium leading-6 text-gray-600">no punggung</label>
          <div class="mt-2">
            <input  type="text" name="no_punggung" value="{{$data ->no_punggung}}"  class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          </div>
        </div>
        <div class="col-span-full">
          ...
          <label for="street-address" class="block text-sm font-medium leading-6 text-gray-600">desck1</label>
            <input type="text" name="Desck1" value="{{$data ->Desck1}}"  class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          </div>
          <div class="mt-2">
          <label for="street-address" class="block text-sm font-medium leading-6 text-gray-600">desck2</label>
            <input type="text" name="Desck2" value="{{$data ->Desck2}}"  class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          </div>
          <div class="mt-2">
          <label for="street-address" class="block text-sm font-medium leading-6 text-gray-600">desck3</label>
            <input type="text" name="Desck3" value="{{$data ->Desck3}}"  class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          </div>
          <div class="mt-2">
          <label for="street-address" class="block text-sm font-medium leading-6 text-gray-600">desck4</label>
            <input type="text" name="Desck4" value="{{$data ->Desck4}}"  class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          </div>
        </div>
        <div class="col-span-full">
