...
@section('content')
<form action="/admin/updateberita/{{$data -> id}}" method="POST" enctype="multipart/form-data" class="overflow-y-auto h-32">
    ...
    <div class="border-b border-gray-900/10 pb-12">
      ...
      <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        ...
        <div class="sm:col-span-3">
          ...
          <div class="mt-2">
            <input type="text" name="title" value="{{$data->title}}"  class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          </div>
        </div>
        ...
        <div class="sm:col-span-4">
          ...
          <div class="mt-2">
            <input  type="text" name="type_umur" value="{{$data->type_umur}}" class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          </div>
        </div>
        ...
        <div class="col-span-full">
          ...
          <label for="street-address" class="block text-sm font-medium leading-6 text-gray-600">par1</label>
            <input type="text" name="par1" value="{{$data->par1}}" class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          </div>
          <div class="mt-2">
          <label for="street-address" class="block text-sm font-medium leading-6 text-gray-600">par2</label>
            <input type="text" name="par2" value="{{$data->par2}}" class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          </div>
          <div class="mt-2">
          <label for="street-address" class="block text-sm font-medium leading-6 text-gray-600">par3</label>
            <input type="text" name="par3" value="{{$data->par3}}" class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          </div>
          <div class="mt-2">
          <label for="street-address" class="block text-sm font-medium leading-6 text-gray-600">par4</label>
            <input type="text" name="par4" value="{{$data->par4}}" class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          </div>
        </div>
        <div class="col-span-full">
          <label for="street-address" class="block text-sm font-medium leading-6 text-gray-600">par5</label>
          <div class="mt-2">
            <input type="text" name="par5" value="{{$data->par5}}" class="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          </div>
        </div>
        <div class="col-span-full">
